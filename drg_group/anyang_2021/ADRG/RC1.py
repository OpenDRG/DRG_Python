...
from drg_group.anyang_2021.DRG import MDCR_DRG
...
def group(record):
  ...
  if True and record.zdList[0] in adrg_zd and record.ssList and record.ssList[0] in adrg_ss and record.ssList and intersect(record.ssList,adrg_ss):
    ...
    if MDCR_DRG.RC11A_group(record):
      return 'RC11A'

    if MDCR_DRG.RC11B_group(record):
      return 'RC11B'

    if MDCR_DRG.RC1BA_group(record):
      return 'RC14A'

    if MDCR_DRG.RC1BB_group(record):
      return 'RC14B'
