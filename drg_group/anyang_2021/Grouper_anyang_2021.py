import time
from drg_group.anyang_2021.Base import DrgGroupStatus,MedicalRecord,GroupResult,groupMessages,output,DRG
from drg_group.anyang_2021.Grouper import group

class Grouper_anyang_2021:
