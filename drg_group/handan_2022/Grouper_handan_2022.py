import time
from drg_group.handan_2022.Base import DrgGroupStatus,MedicalRecord,GroupResult,groupMessages,output,DRG
from drg_group.handan_2022.Grouper import group

class Grouper_handan_2022:
