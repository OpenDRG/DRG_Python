import time
from drg_group.guangxi_2022.Base import DrgGroupStatus,MedicalRecord,GroupResult,groupMessages,output,DRG
from drg_group.guangxi_2022.Grouper import group

class Grouper_guangxi_2022:
