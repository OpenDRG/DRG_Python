...
def GU10_group(record):
    return record.age<=17
def GV10_group(record):
    return record.age<=17
def GW10_group(record):
    return record.age<=17
...
def GZ19_group(record):
  return True
def GB17_group(record):
  return record.inHospitalTime<5 and record.leavingType in ['2','5']
def GB27_group(record):
  return record.inHospitalTime<5 and record.leavingType in ['2','5']
def GC17_group(record):
  return record.inHospitalTime<5 and record.leavingType in ['2','5']
def GR17_group(record):
  return record.inHospitalTime<5 and record.leavingType in ['2','5']
def GS17_group(record):
  return record.inHospitalTime<5 and record.leavingType in ['2','5']
