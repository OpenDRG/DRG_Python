...
from drg_group.beijing_2022.Grouper_beijing_2022 import Grouper_beijing_2022 as Grouper
from drg_group.beijing_2022.Base import Reader,MedicalRecord,DrgGroupStatus,GroupResult,tuple_to_str
...
class GroupProxy:
  ...
  def group_csv(self,filename,cols):
    ...
    self.group_df(df,open(filename.replace('.csv','_python_result.csv'),'w',encoding='utf-8-sig'),cols)
