...
def group(record):
  ...
  adrg_ss2=[]
  dept_list=[]
  if True and record.zdList[0] in adrg_zd and (not record.ssList or not record.ssList[0] in SS_VALID) and record.weight and record.weight>=1500 and record.weight<2500 and record.ageDay!=None and record.ageDay<=28:
