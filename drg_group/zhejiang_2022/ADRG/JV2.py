...
def group(record):
  ...
  if True and record.zdList[0] in adrg_zd:
    ...
    if MDCJ_DRG.JV21_group(record):
      return 'JV21'

    if MDCJ_DRG.JV23_group(record):
      return 'JV23'
