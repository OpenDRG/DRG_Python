import time
from drg_group.zhejiang_2022.Base import DrgGroupStatus,MedicalRecord,GroupResult,groupMessages,output,DRG
from drg_group.zhejiang_2022.Grouper import group

class Grouper_zhejiang_2022:
