import time
from drg_group.suzhou_2022.Base import DrgGroupStatus,MedicalRecord,GroupResult,messages,output,DRG
from drg_group.suzhou_2022.Grouper import group

class Grouper_suzhou_2022:
