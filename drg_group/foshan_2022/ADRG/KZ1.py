...
from drg_group.foshan_2022.DRG_EX import KZ11,KZ12,KZ13
...
def group(record):
  ...
  if True and record.zdList[0] in adrg_zd:
    ...
    if KZ11.group(record):
      return 'KZ11'

    if KZ12.group(record):
      return 'KZ12'

    if KZ13.group(record):
      return 'KZ13'

    
    if MDCK_DRG.KZ14_group(record):
      return 'KZ14'

    if MDCK_DRG.KZ15_group(record):
      return 'KZ15'

    if MDCK_DRG.KZ16_group(record):
      return 'KZ16'
