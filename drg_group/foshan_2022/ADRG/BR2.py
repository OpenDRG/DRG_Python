...
def group(record):
  ...
  if True and record.zdList[0] in adrg_zd:
    ...
    if BR21.group(record):
      return 'BR21'

    if BR22.group(record):
      return 'BR22'

    if BR23.group(record):
      return 'BR23'

    if BR27.group(record):
      return 'BR27'
