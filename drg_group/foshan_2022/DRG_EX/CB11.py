...
def group(record):
  ...
  adrg_ss1=[]
  adrg_ss2=[]
  if True and record.ssList and record.ssList[0] in adrg_ss and record.ssList and intersect(record.ssList,adrg_ss) and intersect(record.ssList,adrg_ss1):
    message('符合CB11入组条件，匹配规则：主手术匹配、双手术匹配')
    return True