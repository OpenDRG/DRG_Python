import time
from drg_group.fuzhou_2022.Base import DrgGroupStatus,MedicalRecord,GroupResult,groupMessages,output,DRG
from drg_group.fuzhou_2022.Grouper import group

class Grouper_fuzhou_2022:
