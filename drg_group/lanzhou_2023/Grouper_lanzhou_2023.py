import time
from drg_group.lanzhou_2023.Base import DrgGroupStatus,MedicalRecord,GroupResult,groupMessages,output,DRG
from drg_group.lanzhou_2023.Grouper import group

class Grouper_lanzhou_2023:
