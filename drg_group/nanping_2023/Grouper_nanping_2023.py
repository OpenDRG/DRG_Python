import time
from drg_group.nanping_2023.Base import DrgGroupStatus,MedicalRecord,GroupResult,groupMessages,output,DRG
from drg_group.nanping_2023.Grouper import group

class Grouper_nanping_2023:
