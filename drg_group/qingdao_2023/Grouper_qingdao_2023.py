import time
from drg_group.qingdao_2023.Base import DrgGroupStatus,MedicalRecord,GroupResult,groupMessages,output,DRG
from drg_group.qingdao_2023.Grouper import group

class Grouper_qingdao_2023:
