...
from drg_group.suzhou_2023.Grouper_suzhou_2023 import Grouper_suzhou_2023 as Grouper
from drg_group.suzhou_2023.Base import Reader,MedicalRecord,DrgGroupStatus,GroupResult,tuple_to_str
...
class GroupProxy:
  ...
  def trans(self,record):
    ...
    ss_list=re.split(',|\|',record.ss_list)
    ss_no_map=[]
    for x in ss_list:
      if x in self.SS_MAP:
