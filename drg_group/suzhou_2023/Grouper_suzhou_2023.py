import time
from drg_group.suzhou_2023.Base import DrgGroupStatus,MedicalRecord,GroupResult,messages,output,DRG
from drg_group.suzhou_2023.Grouper import group

class Grouper_suzhou_2023:
