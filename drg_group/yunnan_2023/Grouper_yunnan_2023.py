import time
from drg_group.yunnan_2023.Base import DrgGroupStatus,MedicalRecord,GroupResult,create_result,groupMessages,output,DRG
from drg_group.yunnan_2023.Grouper import group

class Grouper_yunnan_2023:
