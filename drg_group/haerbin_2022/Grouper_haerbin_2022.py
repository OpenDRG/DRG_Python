import time
from drg_group.haerbin_2022.Base import DrgGroupStatus,MedicalRecord,GroupResult,groupMessages,output,DRG
from drg_group.haerbin_2022.Grouper import group

class Grouper_haerbin_2022:
