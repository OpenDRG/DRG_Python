...
from drg_group.hefei_2023.DRG_EX import FD3X

def group(record):
  adrg_zd=[]
  adrg_zd1=[]
  adrg_ss=["35.4200x003","35.4200x009","35.5200x001","35.5200x002","35.5201","35.5500x001","35.9800x001","35.9800x002","36.9900x005","36.9901","39.7800x008","39.7900x402"]
  adrg_ss1=[]
  adrg_ss2=[]
  dept_list=[]
