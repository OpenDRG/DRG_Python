...
def group(record):
  ...
  adrg_ss2=[]
  dept_list=[]
  if True and intersect(record.zdList[1:],adrg_zd1) and record.ssList and record.ssList[0] in adrg_ss and record.ssList and intersect(record.ssList,adrg_ss):
    message('符合WB1_2入组条件，匹配规则：其他诊断匹配、主手术匹配、某一手术匹配')
