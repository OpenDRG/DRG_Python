import time
from drg_group.linfen_2022.Base import DrgGroupStatus,MedicalRecord,GroupResult,groupMessages,output,DRG
from drg_group.linfen_2022.Grouper import group

class Grouper_linfen_2022:
