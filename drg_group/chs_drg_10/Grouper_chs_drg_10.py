import time
from drg_group.chs_drg_10.Base import DrgGroupStatus,MedicalRecord,GroupResult,groupMessages,output,DRG
from drg_group.chs_drg_10.Grouper import group

class Grouper_chs_drg_10:
