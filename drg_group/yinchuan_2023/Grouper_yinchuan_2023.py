import time
from drg_group.yinchuan_2023.Base import DrgGroupStatus,MedicalRecord,GroupResult,groupMessages,output,DRG
from drg_group.yinchuan_2023.Grouper import group

class Grouper_yinchuan_2023:
