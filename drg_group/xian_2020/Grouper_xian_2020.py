import time
from drg_group.xian_2020.Base import DrgGroupStatus,MedicalRecord,GroupResult,groupMessages,output,DRG
from drg_group.xian_2020.Grouper import group

class Grouper_xian_2020:
